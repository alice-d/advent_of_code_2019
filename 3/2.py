intersectionsL =[[446, 0], [1003, -28], [662, -28], [662, 350], [-1106, -252], [-367, -605], [-367, -693], [-1139, -1069], [-1526, -1078], [-1913, -351], [-1913, -505], [-1403, -252], [-1004, -148], [-1423, -252], [-1913, -670], [-1767, -252], [-1913, -274], [-2316, -988], [-2380, -1521]]
intersections = list(map(tuple,intersectionsL))
inter_steps={}
for i in intersections:
    inter_steps[i]=0

def addToPath(path,curr,coord,quant,add,dist):
    ...
    for i in range(1,quant+1):
        ...
        #print(this)
        dist+=1
        if (this in intersectionsL):
            inter_steps[(this[0],this[1])]+=dist
        path.append(this)
    return dist
...
for w in range(2):
    ...
    for i in range (0,len(directions)):
        ...
        if (direction=="R"):
            dist=addToPath(path,this,0,quant,True,dist)
            #this[0]+=quant
        elif (direction=="L"):
            dist=addToPath(path,this,0,quant,False,dist)
            #this[0]-=quant
        elif (direction=="U"):
            dist=addToPath(path,this,1,quant,True,dist)
            #this[1]+=quant
        elif (direction=="D"):
            dist=addToPath(path,this,1,quant,False,dist)
            #this[1]-=quant
        #path.append(this)
    paths.append(path)
...
import sys
val=sys.maxsize
for inter in inter_steps:
    if (inter_steps[inter]<val):
        val=inter_steps[inter]
print(val)